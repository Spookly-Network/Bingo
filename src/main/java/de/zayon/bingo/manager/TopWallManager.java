...
import de.zayon.bingo.util.UUIDFetcher;
...
//        HashMap<Integer, String> rang = new HashMap<>();
        ...
        this.bingo.getDatabaseLib().executeQueryAsync("SELECT * FROM zayon_mc_main.zayon_bingo_stats ORDER BY wins DESC LIMIT 10", resultSet -> {
